            ...
            <div className="row align-items-center justify-content-between">
              <div className="col-md-6 col-lg-6">
                <div className="hero-content-left ptb-100 text-white">
                  ...
                  <p className="lead">
                  Nossa missão é desenvolver softwares de altíssima qualidade que escale o negócio de nossos clientes. 
                  Com ampla atuação no mercado, nós atendemos diversos tipos de instituições com negócios digitais.
                  </p>
