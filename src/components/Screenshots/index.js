          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-8">
                <div className="section-heading text-center">
                  <h2>
                    Apps à Sistemas Web<br /> <span>Nossas soluções vem das suas ideias</span>
                  </h2>
                  <p className="lead">
                    {" "}
                  </p>
            ...
            <div className="screen-slider-content mt-5">
              ...
              <div className="screen-carousel owl-carousel owl-theme dot-indicator">
                <img src="https://cascataxi-85210.web.app/static/media/triobanner.0ce039fa.png"
                     className="img-fluid" alt="screenshots" />
